...
export default function About() {
        ...
        return <Draggable>
                <div style={{
                        ...
                        height: "500px", paddingRight: "20px"
                }}>
                        ...
                        i'm a junior at <a href="https://www.northeastern.edu/" className="other">northeastern university</a><br></br>currently pursuing an honors combined bachelors<br></br>degree in computer science and media arts!<br></br><br></br>
                        ...
                        i've worked professionally with web development-- from june to december of 2023, i worked as a software development co-op for Curriculum Associates to help build their website, Success Central! SC is a website with Next.JS architecture that hosts resources to help those who use the CA product i-Ready in their classrooms. feel free to ask me about my time here, or for a referral!
                        <br></br><br></br>
                        ...
                        open-world video games, baking mediocre bread, DJ-ing, crocheting, tattoos, magical girl anime, looking at <a href="http://story.ja.utf8art.com/" className="other">ASCII art</a>, and taking care of my <a href="https://twitter.com/snails123456789" className = "other">two pet snails!</a> i 
