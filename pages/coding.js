...
export default function Coding() {
    return <div>
            ...
            <h1 className="myHeading2">COMPLETE:</h1>
            <img src="border.gif" style={{ display: "block", width: "900px", height: "10px", marginTop: "10px", marginBottom: "10px" }} />

            <a href="/"><h1 className="myHeading" style={{ textDecoration: "underline" }}>this website!</h1></a>⠀❤
            <h1 className="myHeading2">HTML, CSS, Javascript/React</h1>
            ...
            <img src="border.gif" style={{ display: "block", width: "900px", height: "10px", marginTop: "10px", marginBottom: "10px" }} />
            <a href="https://github.com/zyelsky/databaseProj"><h1 className="myHeading" style={{ textDecoration: "underline" }}>budgeting app database MVP</h1></a>⠀❤
            <h1 className="myHeading2">SQL, DataGrip, Python, Docker, Flask, Appsmith</h1>
            ...
            <img src="border.gif" style={{ display: "block", width: "900px", height: "10px", marginTop: "10px", marginBottom: "10px" }} />
            <a href="https://github.com/ubitinaitis/rgbheadband"><h1 className="myHeading" style={{ textDecoration: "underline" }}>rgb neopixel headband</h1></a>⠀❤
            <h1 className="myHeading2">Python, Arduino, 3D Printing, messy soldering...</h1>
            ...
            <img src="border.gif" style={{ display: "block", width: "900px", height: "10px", marginTop: "10px", marginBottom: "10px" }} />
            <a href="https://nyashidos.itch.io/moonflower"><h1 className="myHeading" style={{ textDecoration: "underline" }}>moonflower, a visual novel</h1></a>⠀❤
            <h1 className="myHeading2">RenPy (Python)</h1>
            ...
            <img src="border.gif" style={{ display: "block", width: "900px", height: "10px", marginTop: "10px", marginBottom: "10px" }} />
            <a href="https://github.com/ubitinaitis/aliceplou-bot"><h1 className="myHeading" style={{ textDecoration: "underline" }}>alice phoebe lou twitter bot</h1></a>⠀❤
            <h1 className="myHeading2">Python, Tweepy (Twitter API)</h1>
            ...
            <img src="border.gif" style={{ display: "block", width: "900px", height: "10px", marginTop: "10px", marginBottom: "10px" }} />
            <h1 className="myHeading" style={{ textDecoration: "underline" }}>mini photoshop</h1>⠀❤
            <h1 className="myHeading2">Java</h1>
            ...
            <img src="border.gif" style={{ display: "block", width: "900px", height: "10px", marginTop: "10px", marginBottom: "10px" }} />
            <h1 className="myHeading" style={{ textDecoration: "underline" }}>automatic maze building + solving</h1>⠀❤
            <h1 className="myHeading2">Java</h1>
            ...
            IN PROGRESS:
            <img src="border.gif" style={{ display: "block", width: "900px", height: "10px", marginTop: "10px", marginBottom: "10px" }} />
            <h1 className="myHeading" style={{ textDecoration: "underline" }}>iquiform</h1>⠀❤ <br></br>
