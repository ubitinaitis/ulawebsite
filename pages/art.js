    ...
    return <div>
                    ...
                    <span class="bubble-text" style={{ overflowY: "auto", float: "left", overflowX: "hidden"}}>
                        <div style={{
                            ...
                            click to expand images and view them fully! (*＾▽＾)／

                            <br />

                            <img src="border.gif" style={{ display: "block", width: "900px", height: "10px", marginTop: "10px", marginBottom: "10px" }} />
                            <h1 class="myHeading">Live2D model demo</h1>⠀❤
                            <h1 class="myHeading2">closed captioning provided, best viewed on desktop!</h1>
                            <img src="border.gif" style={{ display: "block", width: "900px", height: "10px", marginTop: "10px", marginBottom: "10px" }} />

                            <div style={{ display: "flex", justifyContent: "center" }}>
                                <iframe src="https://drive.google.com/file/d/1O7TxP2hTHgi69_dVSoeZMTg2fLMcNF0w/preview" padding="30px"></iframe>
                            </div>

                            <br></br>

                            <div style={{ display: "flex", justifyContent: "center" }}>
                                <iframe src="https://drive.google.com/file/d/1stvzlEzbRXU0cAFh-GfbhQJQbvZzQybD/preview" padding="30px"></iframe>
                            </div>
